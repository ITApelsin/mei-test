...
public class Consumption {
    ...
    public boolean equals(Object o) {
        ...
        return getId() == that.getId() && Double.compare(that.getFactQliqData1(), getFactQliqData1()) == 0 && Double.compare(that.getFactQliqData2(), getFactQliqData2()) == 0 && Double.compare(that.getFactQoilData1(), getFactQoilData1()) == 0 && Double.compare(that.getFactQoilData2(), getFactQoilData2()) == 0 && Double.compare(that.getForecastQliqData1(), getForecastQliqData1()) == 0 && Double.compare(that.getForecastQliqData2(), getForecastQliqData2()) == 0 && Double.compare(that.getForecastQoilData1(), getForecastQoilData1()) == 0 && Double.compare(that.getForecastQoilData2(), getForecastQoilData2()) == 0 && Objects.equals(getCompany(), that.getCompany()) && Objects.equals(getConsumptionDate(), that.getConsumptionDate());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getCompany(), getConsumptionDate(), getFactQliqData1(), getFactQliqData2(), getFactQoilData1(), getFactQoilData2(), getForecastQliqData1(), getForecastQliqData2(), getForecastQoilData1(), getForecastQoilData2());
    }
